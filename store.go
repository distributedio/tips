...
type Pubsub interface {
	...
	Publish(cxt context.Context, msg []string, topic string) (msgids []string, cursor []int64, err error)
	...
	Pull(cxt context.Context, subName string, index int64, limit int64, ack bool) (messages []string, offset int64, err error)
	...
	Seek(cxt context.Context, name string) (index int64)
}
